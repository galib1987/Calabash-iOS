...
+ (void)presentMessage:(NCLMessage*)message shouldAutoDismiss:(BOOL)shouldAutoDismiss
{
    [[self sharedInstance] pushViewWithMessage:message shouldAutoDismiss:shouldAutoDismiss];
}
