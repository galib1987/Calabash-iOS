...
// Make changes to NJOPAirport.h instead.

@import CoreData;

extern const struct NJOPAirportAttributes {
...
} NJOPAirportAttributes;

@interface NJOPAirportID : NSManagedObjectID {}
@end

@interface _NJOPAirport : NSManagedObject {}
+ (id)insertInManagedObjectContext:(NSManagedObjectContext*)moc_;
+ (NSString*)entityName;
+ (NSEntityDescription*)entityInManagedObjectContext:(NSManagedObjectContext*)moc_;
@property (nonatomic, readonly, strong) NJOPAirportID* objectID;
...
@property (atomic) BOOL customs_availableValue;
...
@property (atomic) int16_t elevation_qtyValue;
...
@property (atomic) BOOL fuel_availableValue;
...
@property (atomic) BOOL instrument_approach_flagValue;
...
@property (atomic) int16_t longest_runway_length_qtyValue;
...
@property (atomic) BOOL slots_requiredValue;
...
@interface _NJOPAirport (CoreDataGeneratedPrimitiveAccessors)
