...
// Make changes to NJOPFBO.h instead.

@import CoreData;

extern const struct NJOPFBOAttributes {
...
extern const struct NJOPFBORelationships {
	__unsafe_unretained NSString *fboaddress;
	__unsafe_unretained NSString *fbophone;
} NJOPFBORelationships;

@class NJOPFBOAddress;
@class NJOPFBOPhone;

@interface NJOPFBOID : NSManagedObjectID {}
@end

@interface _NJOPFBO : NSManagedObject {}
+ (id)insertInManagedObjectContext:(NSManagedObjectContext*)moc_;
+ (NSString*)entityName;
+ (NSEntityDescription*)entityInManagedObjectContext:(NSManagedObjectContext*)moc_;
@property (nonatomic, readonly, strong) NJOPFBOID* objectID;
...
@property (atomic) int16_t fbo_ranking_qtyValue;
...
@interface _NJOPFBO (FboaddressCoreDataGeneratedAccessors)
- (void)addFboaddress:(NSSet*)value_;
- (void)removeFboaddress:(NSSet*)value_;
- (void)addFboaddressObject:(NJOPFBOAddress*)value_;
- (void)removeFboaddressObject:(NJOPFBOAddress*)value_;

@end

@interface _NJOPFBO (FbophoneCoreDataGeneratedAccessors)
- (void)addFbophone:(NSSet*)value_;
- (void)removeFbophone:(NSSet*)value_;
- (void)addFbophoneObject:(NJOPFBOPhone*)value_;
- (void)removeFbophoneObject:(NJOPFBOPhone*)value_;

@end

@interface _NJOPFBO (CoreDataGeneratedPrimitiveAccessors)
