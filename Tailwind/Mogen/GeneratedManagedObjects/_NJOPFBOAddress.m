...
// Make changes to NJOPFBOAddress.m instead.

#import "_NJOPFBOAddress.h"

const struct NJOPFBOAddressAttributes NJOPFBOAddressAttributes = {
...
const struct NJOPFBOAddressRelationships NJOPFBOAddressRelationships = {
	.fboAddressParent = @"fboAddressParent",
};

@implementation NJOPFBOAddressID
@end

@implementation _NJOPFBOAddress
...
- (NJOPFBOAddressID*)objectID {
	return (NJOPFBOAddressID*)[super objectID];
}
...
- (void)setPrimitiveAddress_idValue:(int32_t)value_ {
	[self setPrimitiveAddress_id:@(value_)];
}
